...
TEST_CSV_FULL_PATH = 'C:\Users\didac\Documents\SSE\Web_Economics\Coursework\Dataset\ipinyou_train.csv'
...
def PrintExpectedLogAgainstResult(expected_log, result_log):
        for (log_number),(row_log_ex, row_log_re) in enumerate(zip(expected_log,result_log)):
            print 'LOG NUMBER ' +str(log_number)
            for (key_ex, value_ex) in row_log_ex.items():
                print key_ex + ':' + value_ex
                print key_ex + ':' + row_log_re[key_ex]
                print ''
