...
TransformDataFrame <- function(data_frame){
  ...
  #Split useragent in os and browser
...
TransformFactorParameterToNumeric <- function(data_frame, parameter_name) {
  #Calculate Frequency of levels in parameter
  ...
  #Calculate CTR of levels in parameter
...
write.csv(evaluation, file = "Evaluation_xg_boost.csv", row.names = FALSE, quote=FALSE)
